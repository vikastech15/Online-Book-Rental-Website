...
//   return (
//     <header className="sticky top-0 z-50 shadow-md bg-white/80 backdrop-blur-md w-full">
...
//               <Link to="/browse" className="text-gray-800 hover:text-red-800">Browse</Link>
//               <Link to="/AddBook" className="text-gray-800 hover:text-red-800">Add Book</Link>
//               <Link to="/Cart" className="text-gray-800 hover:text-red-800"> <FontAwesomeIcon icon={faShoppingCart} size="lg" color="black" /></Link>
//                {email==="vikasvermagupta2@gmail.com" && (
//                 <Link to="/Admin" className="text-gray-800 hover:text-red-800 ">  <ShieldCheckIcon className="w-7 h-7 text-red-800" /></Link>
//                )}
...
//               <li><Link to="/browse" className="block text-gray-800 hover:text-red-700">Browse</Link></li>
//               <li><Link to="/AddBook" className="block text-gray-800 hover:text-red-700">Add Book</Link></li>
//             </ul>
...
//                   <div className="mt-2">
//                     <Link to="/profile" className="block text-sm py-1 hover:underline">Profile</Link>
//                     <Link to="/settings" className="block text-sm py-1 hover:underline">Settings</Link>
